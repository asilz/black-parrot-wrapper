...
class BlackParrotTileModuleImp(outer: BlackParrotTile) extends BaseTileModuleImp(outer){
  ...
  val core = Module(new BlackParrotBlackbox(
    pmpEnable = outer.blackParrotParams.core.pmpEnable,
    pmpGranularity = outer.blackParrotParams.core.pmpGranularity,
    pmpNumRegions = outer.blackParrotParams.core.pmpNumRegions,
    mhpmCounterNum = outer.blackParrotParams.core.mhpmCounterNum,
    mhpmCounterWidth = outer.blackParrotParams.core.mhpmCounterWidth,
    rv32e = outer.blackParrotParams.core.rv32e,
    rv32m = rv32mInt.get,
    rv32b = rv32bInt.get,
    regfile = regFileInt.get,
    branchTargetALU = outer.blackParrotParams.core.branchTargetALU,
    wbStage = outer.blackParrotParams.core.wbStage,
    branchPredictor = outer.blackParrotParams.core.branchPredictor,
    dbgHwBreakNum = outer.blackParrotParams.core.dbgHwBreakNum,
    dmHaltAddr = outer.blackParrotParams.core.dmHaltAddr,
    dmExceptionAddr = outer.blackParrotParams.core.dmExceptionAddr
  ))
